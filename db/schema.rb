...
ActiveRecord::Schema.define(version: 2021_02_11_190059) do
  ...
  create_table "comment_videos", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_comment_videos_on_user_id"
    t.index ["video_id"], name: "index_comment_videos_on_video_id"
  end
  ...
  add_foreign_key "comment_videos", "users"
  add_foreign_key "comment_videos", "videos"
end
